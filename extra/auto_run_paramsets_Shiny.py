...
if __name__ == '__main__':
    ...
    datafolder = '/home/ksb/dataset/refnerf/'
    param_dict = {
        'data_name': ['ball', 'car', 'coffee', 'helmet', 'teapot', 'toaster'],
        'core_num': [7],
        'num_level': [8]
        # 'data_dim_color': [27]
    }
    ...
    def run_program(gpu, expname, param):
        cmd = f'CUDA_VISIBLE_DEVICES={gpu}  /home/ksb/miniconda3/envs/TensoRF/bin/python3 ../train.py ' \
            f'--expname {expname} --basedir ./log/{expFolder} --config ../configs/shiny.txt ' \
            f'{param}' \
