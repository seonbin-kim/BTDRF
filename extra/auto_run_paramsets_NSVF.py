...
if __name__ == '__main__':
    ...
    #nsvf
    expFolder = "nsvf_3_re/"
    datafolder = '/home/ksb/TensoRF_Transformer_Triplane_Explicit_test/data/Synthetic_NSVF/'
    param_dict = {
    ...
    def run_program(gpu, expname, param):
        cmd = f'CUDA_VISIBLE_DEVICES={gpu}  /home/ksb/miniconda3/envs/TensoRF/bin/python3 ../train_3.py ' \
            f'--expname {expname} --basedir ./log/{expFolder} --config ../configs/wineholder.txt ' \
            f'{param}' \
