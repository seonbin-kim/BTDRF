...
if __name__ == '__main__':
    ...
    # nerf
    expFolder = "nerf_5_rerere/"
    #     # parameters to iterate, use tuple to couple multiple parameters
    datafolder = '/home/ksb/TensoRF_Transformer_Triplane_Explicit_test/data/nerf_synthetic/'
    param_dict = {
    ...
    def run_program(gpu, expname, param):
        cmd = f'CUDA_VISIBLE_DEVICES={gpu}  /home/ksb/miniconda3/envs/TensoRF/bin/python3 ../train_5.py ' \
