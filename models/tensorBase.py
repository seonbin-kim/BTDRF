...
class TensorBase(torch.nn.Module):
    def __init__(self, aabb, gridSize, device, density_n_comp=8, appearance_n_comp=24, app_dim=27,
                 ...
                 fea2denseAct='softplus', core_num=1, num_level=8):
        ...
        self.shadingMode, self.pos_pe, self.view_pe, self.fea_pe, self.featureC, self.num_level = shadingMode, pos_pe, view_pe, fea_pe, featureC, num_level
    ...
    def forward(self, rays_chunk, white_bg=True, is_train=False, ndc_ray=False, N_samples=-1):
        ...
        if app_mask.any():
            valid_viewdirs = viewdirs[app_mask]
            valid_weights = weight[app_mask]

            app_features = self.compute_appfeature(xyz_sampled[app_mask])
            valid_rgbs, normals = self.rendering_net(valid_viewdirs, app_features)
