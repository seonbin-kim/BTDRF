...
def config_parser(cmd=None):
    ...
    parser.add_argument('--model_name', type=str, default='BTDRF',
                        choices=['TensorVMSplit', 'BTDRF'])
    ...
    parser.add_argument('--dataset_name', type=str, default='blender',
                        choices=['blender', 'llff', 'nsvf', 'dtu', 'tankstemple', 'shiny'])

    # training options
    # learning rate
    parser.add_argument("--lr_init", type=float, default=0.02,
                        help='learning rate')
    parser.add_argument("--lr_core", type=float, default=0.001,
                        help='learning rate')
    ...
    parser.add_argument("--L1_weight_rest", type=float, default=0,
                        help='loss weight')
    parser.add_argument("--Orientation_loss", type=float, default=0.0,
                        help='loss weight')
    ...
    parser.add_argument("--alpha_mask_thre", type=float, default=0.00001, # 0.002
                        help='threshold for creating alpha mask volume')
    parser.add_argument("--distance_scale", type=float, default=25, # 25
    ...
    parser.add_argument("--core_num", type=int, default=2,
                        help='number of core tensors')
    parser.add_argument("--num_level", type=int, default=8,
    ...
    parser.add_argument('--contract_ray', type=int, default=0)
    parser.add_argument('--nSamples', type=int, default=1e6,  # 1e6
    ...
    parser.add_argument('--N_voxel_final',
                        type=int,
                        default=300 ** 3)
    parser.add_argument('--voxel_init',
                        type=int,
                        default=100)
    parser.add_argument('--voxel_final',
                        type=int,
                        default=300)
